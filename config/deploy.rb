...
set :deploy_to, '/home/rb/work/pgate_query'
set :repository, 'git://github.com/solo123/pgate_query.git'
set :branch, 'deploy'
...
task :pull => :environment do
  ...
  queue  %{echo "app_name = 'pgate_query'" > config/puma.rb && cat ../puma/pgate.rb >> config/puma.rb}
  ...
  queue  %{touch /home/rb/tmp/pids/pgate_query.state}
  queue! %{pumactl restart}

  queue %{echo "====== test after pull ======"}
  queue! %{curl -X POST -d 'data={"org_id":"123"}' http://a.pooulcloud.cn:8009/query}
end
